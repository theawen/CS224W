...
def save_model_res(model, data, run):
    model.eval()
    pred = model(data)
    os.makedirs("./output", exist_ok=True)
    torch.save(pred, f"./output/{run}.pt")
...
def main():
    ...
    parser.add_argument('--save-pred', type=bool, default=True, help='save final predictions')
